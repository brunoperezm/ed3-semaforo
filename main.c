...
uint32_t secuencia_Tiempo[4]= {10,5,10,5};
uint32_t Intensidad[4]={ 1000,2000,4000,5000};
...
void confTIMER1(void){      //ESTE VA A CONTROLAR CADA CUANTO MUESTREA EL ADC
    ...
    //REVISAR CALCULO
    match_cfg.MatchValue=100;                                       //cuando el timer llegue a 100 match es decir 600 segundos o 10 minutos.
     /*---------------------------------------------------------------------------------------------------------------*/
...
void confADC(){
    ...
    ADC_IntConfig (LPC_ADC, 0, ENABLE);                             //activo interrupción para canal 0
